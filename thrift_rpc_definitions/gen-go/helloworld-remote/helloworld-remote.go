...
var _ = helloworldinf.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  HelloRsp SayHello(HelloReq req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := helloworldinf.NewHelloworldClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "SayHello":
    ...
    argvalue0 := helloworldinf.NewHelloReq()
    err12 := argvalue0.Read(context.Background(), jsProt11)
    if err12 != nil {
      Usage()
      return
    }
    value0 := helloworldinf.HelloReq(argvalue0)
